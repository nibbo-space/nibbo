...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return { title: I18N[messageLocale(lang)].onboarding.accountSetupMetaTitle };
}

export default function OnboardingAccountSetupLayout({ children }: { children: React.ReactNode }) {
  return children;
}
